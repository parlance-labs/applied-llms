...
- [Focus on getting the most out of fundamental prompting techniques](#focus-on-getting-the-most-out-of-fundamental-prompting-techniques)
- [Structure your inputs and outputs](#structure-your-inputs-and-outputs)
- [Have small prompts that do one thing, and only one thing, well](#have-small-prompts-that-do-one-thing-and-only-one-thing-well)
- [Craft your context tokens](#craft-your-context-tokens)

#### [Information Retrieval / RAG](#information-retrieval--rag)
- [RAG is only as good as the retrieved documents' relevance, density, and detail](#the-quality-of-your-rags-output-is-dependent-on-the-quality-of-retrieved-documents-which-in-turn-can-be-considered-along-a-few-factors)
- [Don’t forget keyword search; use it as a baseline and in hybrid search](#dont-forget-keyword-search-use-it-as-a-baseline-and-in-hybrid-search)
- [Prefer RAG over fine-tuning for new knowledge](#prefer-rag-over-fine-tuning-for-new-knowledge)
- [Long-context models won't make RAG obsolete](#long-context-models-wont-make-rag-obsolete)

#### [Tuning and optimizing workflows](#tuning-and-optimizing-workflows)
- [Step-by-step, multi-turn “flows” can give large boosts](#step-by-step-multi-turn-flows-can-give-large-boosts)
- [Prioritize deterministic workflows for now](#prioritize-deterministic-workflows-for-now)
- [Getting more diverse outputs beyond temperature](#getting-more-diverse-outputs-beyond-temperature)
- [Caching is underrated](#caching-is-underrated)
- [When to finetune](#when-to-finetune)

#### [Evaluation & Monitoring](#evaluation--monitoring)
- [Create a few assertion-based unit tests from real input/output samples](#create-a-few-assertion-based-unit-tests-from-real-inputoutput-samples)
- [LLM-as-Judge can work (somewhat), but it's not a silver bullet](#llm-as-judge-can-work-somewhat-but-its-not-a-silver-bullet)
- [The “intern test” for evaluating generations](#the-intern-test-for-evaluating-generations)
- [Overemphasizing certain evals can hurt overall performance](#overemphasizing-certain-evals-can-hurt-overall-performance)
- [Simplify annotation to binary tasks or pairwise comparisons](#simplify-annotation-to-binary-tasks-or-pairwise-comparisons)
- [(Reference-free) evals and guardrails can be used interchangeably](#reference-free-evals-and-guardrails-can-be-used-interchangeably)
- [LLMs will return output even when they shouldn't](#llms-will-return-output-even-when-they-shouldnt)
- [Hallucinations are a stubborn problem](#hallucinations-are-a-stubborn-problem)

### [Operation: Day-to-day and org concerns](#operation-day-to-day-and-org-concerns)

#### [Data](#data)
- [Check for development-prod skew](#check-for-development-prod-skew)
- [Look at samples of LLM inputs and outputs every day](#look-at-samples-of-llm-inputs-and-outputs-every-day)

#### [Working with models](#working-with-models)
- [Generate structured output to ease downstream integration](#generate-structured-output-to-ease-downstream-integration)
- [Migrating prompts across models is a pain in the ass](#migrating-prompts-across-models-is-a-pain-in-the-ass)
- [Version and pin your models](#version-and-pin-your-models)
- [Choose the smallest model that gets the job done](#choose-the-smallest-model-that-gets-the-job-done)

#### [Product](#product)
- [Involve design early and often](#choose-the-smallest-model-that-gets-the-job-done)
- [Design your UX for Human-In-The-Loop](#design-your-ux-for-human-in-the-loop)
- [Prioritize your hierarchy of needs ruthlessly](#prioritize-your-hierarchy-of-needs-ruthlessly)
- [Calibrate your risk tolerance based on the use case](#calibrate-your-risk-tolerance-based-on-the-use-case)

#### [Team & Roles](#team--roles)
- [Focus on Process, Not Tools](#focus-on-process-not-tools)
- [Always be experimenting](#always-be-experimenting)
- [Empower everyone to use new AI technology](#empower-everyone-to-use-new-ai-technology)
- [Don’t fall into the trap of “AI Engineering is all I need”](#dont-fall-into-the-trap-of-ai-engineering-is-all-i-need)
