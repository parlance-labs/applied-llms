...
<!-- EVALS INLINE CTA START (Evaluation & Monitoring section) -->
:::{.callout-tip .evals-inline-cta}
Want to do this on your own stack with feedback from people who do it for a living? Hamel and Shreya teach a 4-week live course covering error analysis, judge calibration, and the rest of what's in this section.

[**See cohort dates & syllabus →**](https://evals.info)
:::
<!-- EVALS INLINE CTA END -->
...
<!-- BOTTOM CTA START -->
:::{.callout-important .bottom-cta}
If you got something out of this, two of us (Hamel and Shreya) teach a live course where engineers and technical PMs actually build the eval system for an app they're working on. 4 weeks, about 3–4 hrs/week.
